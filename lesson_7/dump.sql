...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 23 2019 г., 11:21
...
(5, 3, 'pp8fhhnr564nlr6302jsivk3vpdisjml'),
(11, 1, 'c6dnl8j0jf4ccmtl00mldldmjs9pbu42'),
(12, 3, 'c6dnl8j0jf4ccmtl00mldldmjs9pbu42');
...
(4, 'Петя!!!2', ' Очень даже', 0),
(5, 'Петя', 'Хороший сайт', 0),
(6, 'Евгения Арестова', 'trtr', 0),
(7, 'Евгения Арестова', '123', 0),
(8, 'Admin222', '31323', 0),
(9, 'Евгения Арестова', '123', 18),
(13, 'Схема', 'ттест', 20),
(14, '11133', '22233', 0);
...
(1, 'matches.png', 'Спички', 'Отличные охотничьи спички.', 12, 10),
...
(1, 'admin', '$2y$10$2qMwxKY7nxxiFZFBP4yzrePkz5WVzb9F7dKO2xux5.XLbPLXkmBEC', '1572649475dfd0cabc8dc79.19440972');
